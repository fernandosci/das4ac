 ...
 * multiple clients.
 */
public class TestClientHistorian extends Client {

    public TestClientHistorian(AuctionServer server, String username, int timeout) throws RemoteException {
    ...
    protected void run_stup() {
        ...
        try {
            Set<UID> availableAuctionItems = session.getLegacyAuctionItems();
            ...
            for (UID id : availableAuctionItems) {
                ...
                Log.LogMessage(this.getClass(), "CLOSED ITEMS:\n " + b.toString());
            }
            Thread.sleep(1000);
